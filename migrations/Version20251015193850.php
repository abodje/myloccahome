 ...
 */
final class Version20251015193850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE organization ADD is_demo TINYINT(1) DEFAULT 0 NOT NULL, ADD subdomain VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE property CHANGE equipment equipment LONGTEXT DEFAULT NULL, CHANGE proximity proximity LONGTEXT DEFAULT NULL, CHANGE restrictions restrictions LONGTEXT DEFAULT NULL, CHANGE notes notes LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE organization DROP is_demo, DROP subdomain');
        ...
        $this->addSql('ALTER TABLE property CHANGE equipment equipment TEXT DEFAULT NULL, CHANGE proximity proximity TEXT DEFAULT NULL, CHANGE restrictions restrictions TEXT DEFAULT NULL, CHANGE notes notes TEXT DEFAULT NULL');
