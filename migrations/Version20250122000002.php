...
/**
 * Migration pour la gestion des impôts fonciers - Version 2.0
 * Crée les tables pour la gestion complète des impôts fonciers avec support multi-tenant
 */
final class Version20250122000002 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create comprehensive tax management system with multi-tenant support - Version 2.0';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // Create tax_declaration table avec tous les champs
        ...
        // Create property_tax table avec tous les champs
        ...
        // Create dgi_form table avec tous les champs
        ...
        // Create tax_document table avec tous les champs
        ...
        // Insérer des données de référence pour les types de déclarations
        ...
        // Insérer des données de référence pour les types de propriétés
        ...
        // Insérer des données de référence pour les catégories fiscales
        ...
        // Insérer des données de référence pour les districts
        ...
        // Insérer des données de référence pour les types de documents
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DELETE FROM district WHERE code IN ("ABJ", "BOU", "DAL", "KOR", "SAN", "YAM", "GAG", "MAN", "DIV")');
