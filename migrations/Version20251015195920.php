 ...
 */
final class Version20251015195920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company ADD is_demo TINYINT(1) DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE lease ADD is_demo TINYINT(1) DEFAULT 0 NOT NULL, ADD security_deposit NUMERIC(10, 2) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE property ADD is_demo TINYINT(1) DEFAULT 0 NOT NULL, CHANGE equipment equipment LONGTEXT DEFAULT NULL, CHANGE proximity proximity LONGTEXT DEFAULT NULL, CHANGE restrictions restrictions LONGTEXT DEFAULT NULL, CHANGE notes notes LONGTEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE property RENAME INDEX idx_property_organization TO IDX_8BF21CDE32C8A3DE');
        $this->addSql('ALTER TABLE property RENAME INDEX idx_property_company TO IDX_8BF21CDE979B1AD6');
        $this->addSql('ALTER TABLE tenant ADD is_demo TINYINT(1) DEFAULT 0 NOT NULL, ADD status VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company DROP is_demo');
        ...
        $this->addSql('ALTER TABLE lease DROP is_demo, DROP security_deposit');
        ...
        $this->addSql('ALTER TABLE property DROP is_demo, CHANGE equipment equipment TEXT DEFAULT NULL, CHANGE proximity proximity TEXT DEFAULT NULL, CHANGE restrictions restrictions TEXT DEFAULT NULL, CHANGE notes notes TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE property RENAME INDEX idx_8bf21cde979b1ad6 TO IDX_property_company');
        $this->addSql('ALTER TABLE property RENAME INDEX idx_8bf21cde32c8a3de TO IDX_property_organization');
        ...
        $this->addSql('ALTER TABLE tenant DROP is_demo, DROP status');
