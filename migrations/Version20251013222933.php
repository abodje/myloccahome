 ...
 */
final class Version20251013222933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property ADD organization_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tenant ADD organization_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property DROP organization_id');
        ...
        $this->addSql('ALTER TABLE tenant DROP organization_id');
